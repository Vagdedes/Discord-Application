...
class BotDatabaseTable
{
    public const
        ...
        BOT_CHANNEL_NOTIFICATIONS_TRACKING = "discord.botChannelNotificationsTracking",
        BOT_CHANNEL_NOTIFICATIONS_ROLE_EXEMPTIONS = "discord.botChannelNotificationsRoleExemptions",
